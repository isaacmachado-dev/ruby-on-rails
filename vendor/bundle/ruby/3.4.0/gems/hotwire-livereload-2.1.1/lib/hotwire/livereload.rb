  ...
  module Livereload
    ...
    class << self
      ...
      def server_process?
        ...
        falcon_process = defined?(::Falcon) && File.basename($0) == "falcon"
        itsi_process = defined?(::Itsi) && File.basename($0) == "itsi"
        rails_server = defined?(Rails::Server)

        !!(puma_process || falcon_process || itsi_process || rails_server)
      end
